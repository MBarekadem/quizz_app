...
public class C2q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2q2);
...
// On met score dans un tableau pour pouvoir le modifier dans le listener
        ...
        btn.setOnClickListener(v -> {
            if (radioGroup.getCheckedRadioButtonId() == -1) {
                Toast.makeText(essths.li3.mobile.c2.C2q2.this, "Veuillez choisir une réponse", Toast.LENGTH_SHORT).show();
            } else {
                Intent i=new Intent(this, C2q3.class);
