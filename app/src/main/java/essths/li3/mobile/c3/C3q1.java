...
public class C3q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c3q1);
        ...
        btn.setOnClickListener(v -> {
            if (radioGroup.getCheckedRadioButtonId() == -1) {
                Toast.makeText(essths.li3.mobile.c3.C3q1.this, "Veuillez choisir une réponse", Toast.LENGTH_SHORT).show();
            } else {
                Intent i=new Intent(this, C3q2.class);
