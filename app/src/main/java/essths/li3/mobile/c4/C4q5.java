...
public class C4q5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4q5);
...
// On met score dans un tableau pour pouvoir le modifier dans le listener
        ...
        btn.setOnClickListener(v -> {
            if (radioGroup.getCheckedRadioButtonId() == -1) {
                Toast.makeText(essths.li3.mobile.c4.C4q5.this, "Veuillez choisir une réponse", Toast.LENGTH_SHORT).show();
            } else {
                Intent i=new Intent(this, MainActivity.class);
                i.putExtra("score_s", score[0]);
                startActivity(i);
            }
