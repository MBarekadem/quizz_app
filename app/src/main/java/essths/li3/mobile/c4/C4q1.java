...
public class C4q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4q1);
        ...
        btn.setOnClickListener(v -> {
            if (radioGroup.getCheckedRadioButtonId() == -1) {
                Toast.makeText(essths.li3.mobile.c4.C4q1.this, "Veuillez choisir une réponse", Toast.LENGTH_SHORT).show();
            } else {
                Intent i=new Intent(this, C4q2.class);
